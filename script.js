...
amys:{
  name:"Amys Arms",city:"UMZINTO",logo:"assets/amys-arms-logo.jpg",
...
function load(k){
  ...
  $("logo").classList.toggle("amys-logo",k==="amys");
  ...
  $("whatsapp").textContent="JOIN "+d.city+" WHATSAPP GROUP";
...
document.querySelectorAll(".tabs button").forEach(
  b=>b.onclick=()=>load(b.dataset.key)
);
